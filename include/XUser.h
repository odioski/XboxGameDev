...
EXTERN_C __declspec(deprecated("XUserGetMsaTokenSilentlyAsync is no longer supported. For more information, see the documentation."))
HRESULT STDAPICALLTYPE XUserGetMsaTokenSilentlyAsync(
    _In_ XUserHandle user,
...
EXTERN_C __declspec(deprecated("XUserGetMsaTokenSilentlyResult is no longer supported. For more information, see the documentation."))
HRESULT STDAPICALLTYPE XUserGetMsaTokenSilentlyResult(
    _Inout_ XAsyncBlock* async,
...
EXTERN_C __declspec(deprecated("XUserGetMsaTokenSilentlyResultSize is no longer supported. For more information, see the documentation."))
HRESULT STDAPICALLTYPE XUserGetMsaTokenSilentlyResultSize(
    _Inout_ XAsyncBlock* async,
